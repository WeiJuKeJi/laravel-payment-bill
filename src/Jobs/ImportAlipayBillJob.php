 ...
 * 支付宝账单导入任务。
 */
class ImportAlipayBillJob implements ShouldQueue
{
    ...
    public function __construct(
        ...
        $queue = config('payment-bill.queues.alipay_bill_import');
    ...
    public function handle(): void
    {
        ...
        $importer = new AlipayBillImporter($download, $disk);
        ...
        try {
            ...
            $summary['bill_summary_refund_amount'] = $summary['bill_summary_refund_amount'] ?? $result['import_totals']['import_total_refund_amount'] ?? '0.00';
