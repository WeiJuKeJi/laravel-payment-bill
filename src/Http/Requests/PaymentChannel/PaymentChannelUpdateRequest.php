...
class PaymentChannelUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'alipay_service_provider_id' => ['sometimes', 'nullable', 'string', 'max:64'],
            'alipay_app_auth_token' => ['sometimes', 'nullable', 'string', 'max:255'],
            'wechat_mch_id' => ['sometimes', 'nullable', 'string', 'max:64'],
            'wechat_mch_secret_key_v2' => ['sometimes', 'nullable', 'string'],
            'wechat_mch_secret_key' => ['sometimes', 'nullable', 'string', 'max:128'],
            'wechat_app_id' => ['sometimes', 'nullable', 'string', 'max:64'],
            'wechat_mp_app_id' => ['sometimes', 'nullable', 'string', 'max:64'],
            'wechat_mini_app_id' => ['sometimes', 'nullable', 'string', 'max:64'],
            'wechat_sub_mch_id' => ['sometimes', 'nullable', 'string', 'max:64'],
            'wechat_sub_app_id' => ['sometimes', 'nullable', 'string', 'max:64'],
            'wechat_sub_mp_app_id' => ['sometimes', 'nullable', 'string', 'max:64'],
            'wechat_sub_mini_app_id' => ['sometimes', 'nullable', 'string', 'max:64'],
            'extra' => ['sometimes', 'nullable', 'array'],
            'wechat_mch_public_cert_file' => ['sometimes', 'file', 'max:4096'],
            'wechat_mch_secret_cert_file' => ['sometimes', 'file', 'max:4096'],
            'wechat_public_cert_file' => ['sometimes', 'file', 'max:4096'],
            'alipay_app_cert_file' => ['sometimes', 'file', 'max:4096'],
            'alipay_public_cert_file' => ['sometimes', 'file', 'max:4096'],
            'alipay_root_cert_file' => ['sometimes', 'file', 'max:4096'],
        ];
    }
